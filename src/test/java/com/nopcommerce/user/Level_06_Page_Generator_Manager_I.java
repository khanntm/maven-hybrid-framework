...
public class Level_06_Page_Generator_Manager_I extends BaseTestNopCommerce{
  ...
  public void Login_01_With_Empty_Data() {
	  ...
	  //4
	  // Tu homepage click login link - Wa trang Loging
	  loginPage = new UserLoginPageObject(driver);
  ...
  public void Login_02_With_Invalid_Email() {
	...
	// 5 - Tu homepage click login link - Wa trang Loging
	  loginPage = new UserLoginPageObject(driver);
  ...
  public void Login_03_With_Not_Yet_Register_Email() {
	...
	// 6 - Tu homepage click login link - Wa trang Loging
	  loginPage = new UserLoginPageObject(driver);
  ...
  public void Login_04_With_Valid_Email_And_Empty_Password() {
	...
	// 7 - Tu homepage click login link - Wa trang Loging
	  loginPage = new UserLoginPageObject(driver);
  ...
  public void Login_05_With_Valid_Email_And_Wrong_Password() {
	...
	// 8 - Tu homepage click login link - Wa trang Loging
	  loginPage = new UserLoginPageObject(driver);
  ...
  public void Login_06_With_Valid_Email_And_Valid_Password() {
	...
	// 9 - Tu homepage click login link - Wa trang Loging
	  loginPage = new UserLoginPageObject(driver);
